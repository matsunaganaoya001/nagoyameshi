...
public class AdminStoreController {
    ...
    public String edit(@PathVariable(name = "id") Integer id, Model model) {
        ...
        StoreEditForm storeEditForm = 
        		new StoreEditForm(store.getId(), 
        				store.getName(),null, store.getDescription(),store.getPriceLow(), store.getPrice_high(), store.getBusinesshours_open(), store.getBusinesshours_close(), store.getPostalCode(),store.getAddress() ,store.getPhoneNumber(),store.getRegularholiday());
